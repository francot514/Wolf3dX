...
namespace Wolf3d.StateManagement
{
    ...
    class LoadingScreen : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            loadingScreenTexture = content.Load<Texture2D>("Screens/LoadingScreenA");
            progressTexture = content.Load<Texture2D>("Screens/Progress");    
            base.LoadContent();
        }
        /// <summary>
                                                       ...
                                                       bool coveredByOtherScreen)
        {
            ...
            progressBarWidth += (int)gameTime.ElapsedGameTime.TotalMilliseconds + 1;
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (loadingIsSlow)
            {
                ...
                Rectangle progress = new Rectangle((viewport.Width / 2) - 270, viewport.Height - 250, progressBarWidth, progressTexture.Height * 3);
                Rectangle centerScreen = new Rectangle(0, 0, viewport.Width, viewport.Height);
                byte fade = TransitionAlpha;

                // Draw progress bar
                 spriteBatch.Begin();

                spriteBatch.Draw(loadingScreenTexture, centerScreen,
                                 new Color(fade, fade, fade));
                spriteBatch.Draw(progressTexture, progress,
                                 new Color(fade, fade, fade));
        ...
        GameTime GetGameTime(ref long lastTime)
        {
            ...
            return new GameTime(loadStartTime.ElapsedGameTime + elapsedTime, elapsedTime,
                               false);
        }
