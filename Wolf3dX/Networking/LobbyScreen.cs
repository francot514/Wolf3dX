...
namespace Wolf3d.StateManagement
{
    ...
    class LobbyScreen : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            isReadyTexture = content.Load<Texture2D>("Hud/chat_ready");
            hasVoiceTexture = content.Load<Texture2D>("Hud/chat_able");
            isTalkingTexture = content.Load<Texture2D>("Hud/chat_talking");
            voiceMutedTexture = content.Load<Texture2D>("Hud/chat_mute");
            LobbyScreenTexture = content.Load<Texture2D>("Screens/Lobby");
        }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            Vector2 position = new Vector2(20, 150);
            ...
            spriteBatch.Draw(LobbyScreenTexture, fullscreen,
        ...
        void DrawGamer(NetworkGamer gamer, Vector2 position)
        {
            ...
            Vector2 iconWidth = new Vector2(44, 0);
