...
//
// Wolf3dX
// Copyright (C) Nexxt Studios. All rights reserved.
//-----------------------------------------------------------------------------
#endregion
...
namespace Wolf3d.StateManagement
{
    ...
    class NetworkBusyScreen : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            gradientTexture = content.Load<Texture2D>("Screens/MessageBox");
            iconTexture = content.Load<Texture2D>("Screens/swastika");
        }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            // Add enough room to spin 
            Vector2 iconSize = new Vector2(iconTexture.Width);

            textSize.X = Math.Max(textSize.X, iconSize.X);
            textSize.Y += iconSize.Y + vPad;
            ...
            // Draw the spinning icon progress indicator.
            float iconRotation = (float)gameTime.TotalGameTime.TotalSeconds * 3;

            Vector2 iconPosition = new Vector2(textPosition.X + textSize.X / 2,
                                              textPosition.Y + textSize.Y -
                                                                        iconSize.Y / 2);

            spriteBatch.Draw(iconTexture, iconPosition, null, color, iconRotation,
                             iconSize / 2, 1, SpriteEffects.None, 0);
